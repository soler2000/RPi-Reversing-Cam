...
"rotation_deg": int(request.form.get("rotation_deg", current["camera"].get("rotation_deg", 0))),
"jpeg_quality": int(request.form.get("jpeg_quality", current["camera"].get("jpeg_quality", 85))),
},
"overlay": {
